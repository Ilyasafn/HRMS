...
const CutiUploadMediaSheet: FC<Props> = ({ cuti, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('cuti.upload-media', cuti.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to cuti</SheetDescription>
        </SheetHeader>
...
export default CutiUploadMediaSheet;
